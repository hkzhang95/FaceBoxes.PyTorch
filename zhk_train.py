...
parser = argparse.ArgumentParser(description='FaceBoxes Training for your own dataset')
parser.add_argument('--dataset', default='pig_face', help='Training dataset name')
parser.add_argument('-b', '--batch_size', default=32, type=int, help='Batch size for training')
parser.add_argument('--num_workers', default=8, type=int, help='Number of workers used in dataloading')
parser.add_argument('--pin_memory', action="store_true", default=False, help='Speed up dataloading')
...
training_dataset = os.path.join('data', args.dataset)
save_folder = os.path.join('weights', args.dataset)
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            batch_iterator = iter(data.DataLoader(dataset, batch_size, shuffle=True, num_workers=num_workers,
                                                  pin_memory=args.pin_memory, collate_fn=detection_collate))
